...
`docs/01-business-requirement`. Bối cảnh cụ thể của dự án (WHY/WHO/WHAT) đi thẳng vào
`docs/01-04` qua skill `/setup-context`, không nháp ở đây — file này chỉ giữ lại "Giai đoạn
